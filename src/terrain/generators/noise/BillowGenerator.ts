/**
 * Billow noise terrain generator.
 * Creates soft, puffy, cloud-like terrain.
 */
...
export class BillowGenerator extends TerrainGenerator {
    readonly metadata: TerrainGeneratorMetadata = {
        id: 'billow',
        name: 'Billow Noise',
        category: 'noise',
        description: 'Billow noise for soft, puffy terrain features',
        params: [
...
generatorRegistry.register(new BillowGenerator());
